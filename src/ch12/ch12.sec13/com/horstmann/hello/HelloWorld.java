...
javac -p com.horstmann.greetsvc \
   ch12.sec13/com/horstmann/hello/HelloWorld.java \
   ch12.sec13/module-info.java
java -p com.horstmann.greetsvc:ch12.sec13 \
   -m ch12.sec13/com.horstmann.hello.HelloWorld de

Or more concisely:

javac --module-source-path . -d . -m com.horstmann.greetsvc
javac -p . --module-source-path . -d . -m ch12.sec13
java -p . -m ch12.sec13/com.horstmann.hello.HelloWorld de
